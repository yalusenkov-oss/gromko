  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pt-16 pb-24">
      ...
      <div className="relative h-72 md:h-96 overflow-hidden">
        {/* Blurred background */}
        <div className="absolute inset-0" style={{ backgroundImage: `url(${bannerImage})`, backgroundSize: 'cover', backgroundPosition: 'center top', filter: 'blur(4px) saturate(1.1)', transform: 'scale(1.03)' }} />
