    ...
    <div className="min-h-screen bg-zinc-950 text-white pt-14">
      ...
      {heroTrack && (
        ...
        >
          ...
          <div className="absolute inset-0" style={{ backgroundImage: `url(${heroTrack.cover})`, backgroundSize: 'cover', backgroundPosition: 'center', filter: 'blur(8px) saturate(1.2)', transform: 'scale(1.05)' }} />
