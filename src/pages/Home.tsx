            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {popularAlbums.map(album => (
                  <Link key={album.name} to={`/artist/${album.artistSlug}?album=${encodeURIComponent(album.name)}`} state={{ openAlbum: true }} className="group relative block rounded-xl overflow-hidden">
