...
export default function TracksPage() {
  const { tracks, player, playTrack, currentUser, toggleAlbumLike, toggleShuffle } = useStore();
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/15 text-white rounded-full text-sm font-medium transition-colors active:scale-95"
          >
            <Shuffle size={16} />
            Перемешать всё
          </button>
